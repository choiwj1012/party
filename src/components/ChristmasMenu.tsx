...
const ChristmasMenu = () => {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // PDF 다운로드
      pdf.save('Christmas-Dinner-Menu.pdf');
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-amber-900 to-gray-800">
      ...
      <div className="fixed top-4 right-4 z-50 print:hidden">
        <Button 
          ...
          className="bg-amber-600 hover:bg-amber-700 text-white shadow-lg disabled:opacity-50"
        >
          {isGenerating ? (
            <>
      ...
      {/* Hidden PDF Pages - Original Size for PDF Generation */}
